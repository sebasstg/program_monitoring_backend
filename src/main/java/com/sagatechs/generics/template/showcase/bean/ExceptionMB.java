...
import com.sagatechs.generics.template.exception.AccessDeniedException;
import com.sagatechs.generics.template.exception.BusinessException;
...
public class ExceptionMB implements Serializable {
    ...
    public void throwBusinessException() {
        throw new
                BusinessException("This kind of exception generates a faces message with severity <code>error</code>.");
    }
